...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    // Only subscribe to real-time changes if Supabase is configured
    let menuSubscription: any = { unsubscribe: () => {} }
    let ordersSubscription: any = { unsubscribe: () => {} }

    try {
      menuSubscription = subscribeToMenuItems((payload) => {
        console.log("Menu updated:", payload)
        loadMenuItems()
      })

      ordersSubscription = subscribeToOrders((payload) => {
